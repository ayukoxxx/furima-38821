  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録出来ない時' do
      ...
      it 'first_nameが空では登録できない' do
        @user.first_name = ''
        @user.valid?
        expect(@user.errors.full_messages).to include('First name は入力必須です（全角文字）')
      end
      ...
      it 'family_nameが空では登録できない' do
        @user.family_name = ''
        @user.valid?
        expect(@user.errors.full_messages).to include('Family name は入力必須です（全角文字）')
      end
      ...
      it 'first_name_kanaが空では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('First name kana は入力必須です（全角カナ）')
      end
      ...
      it 'family_name_kanaが空では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('Family name kana は入力必須です（全角カナ）')
      end
